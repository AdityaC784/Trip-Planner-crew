...
class TravelTasks:
    def __tip_section(self):
        return "If you do your best work , i will give you 10,000$ commission!"
    
    def plan_itinerary(self,agent,city,travel_dates,interests):
        return Task(
            description = dedent(
                f'''    
            **Task**: Develop a 7-Days Travel Itinerary , Provide time/datewise Itinerary.
            ...
            **Dont generate more words than needed
            tell which tool you used to get the information
        '''),
        agent=agent,
        expected_output="A detailed 7-day travel itinerary including daily plans, weather, places to eat, packing suggestions, budget, hotels, and restaurants."
    )
    ...
    def identify_city(self,agent, origin, cities,travel_dates,interests):
        return Task(
            description = dedent(
                f'''    
            **Task**: Identify Best City for the Trip.
        ...
        '''),
        agent=agent,
        expected_output="A detailed report on the chosen city, including flight costs, weather forecast, and main attractions."
    )
    ...
    def gather_city_info(self,agent,city,travel_dates,interests):
        ...
        '''),
        agent=agent,
        expected_output="An in-depth city guide with attractions, customs, events, daily recommendations, weather, and cost overview."
    )
